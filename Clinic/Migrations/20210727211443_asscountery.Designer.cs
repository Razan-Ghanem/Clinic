...
namespace Clinic.Migrations
{
    ...
    [Migration("20210727211443_asscountery")]
    partial class asscountery
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Clinic.Models.AppType", b =>
                {
                    ...
                    b.Property<string>("AppointementType")
                        .HasMaxLength(50)
            ...
            modelBuilder.Entity("Clinic.Models.Specialization", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            SpecializationName = "Anesthesiologist"
                        },
                        new
                        {
                            Id = 2L,
                            SpecializationName = "Cardiologists"
                        },
                        new
                        {
                            Id = 3L,
                            SpecializationName = "Hematologist"
                        },
                        new
                        {
                            Id = 4L,
                            SpecializationName = "Radiologist"
                        });
                });

            modelBuilder.Entity("Clinic.Models.Appointment", b =>
                {
                    b.HasOne("Clinic.Models.AppType", "appType")
                        .WithMany()
                        .HasForeignKey("AppId")
